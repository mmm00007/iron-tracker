    ...
    mock_db_pool._conn.fetch.return_value = [
        {
            ...
            "db_movement_pattern": "horizontal_push",
            "set_count": 12,
            "sessions": 3,
        },
        {
            "exercise_name": "Barbell Row",
            "db_movement_pattern": "horizontal_pull",
            "set_count": 12,
            "sessions": 3,
        },
        {
            "exercise_name": "Overhead Press",
            "db_movement_pattern": "vertical_push",
            "set_count": 9,
            "sessions": 3,
        },
        {
            "exercise_name": "Pull Up",
            "db_movement_pattern": "vertical_pull",
            "set_count": 12,
            "sessions": 3,
        },
        {
            "exercise_name": "Squat",
            "db_movement_pattern": "squat",
            "set_count": 15,
            "sessions": 3,
        },
        {
            "exercise_name": "Romanian Deadlift",
            "db_movement_pattern": "hip_hinge",
            "set_count": 12,
            "sessions": 3,
        },
    ]
